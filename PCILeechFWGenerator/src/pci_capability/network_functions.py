...
from .constants import (  # Common PCI Capability IDs; Extended PCI Capability IDs; Network class codes; Network device ID thresholds; Network device patterns; Enterprise patterns; BAR configuration constants; Queue count constants; VF constants; Latency constants; SR-IOV constants; MSI-X BAR allocation patterns; Additional vendor IDs; Common device ID masks; Entropy and variation constants
    BASE_QUEUE_COUNT,
    BASE_REGISTER_SIZE_ADVANCED,
    BASE_REGISTER_SIZE_BASIC,
    BASE_VF_COUNT,
    BROADCOM_ENTERPRISE_MASK,
    ...
    DEVICE_ID_THRESHOLD_ADVANCED,
    DEVICE_ID_THRESHOLD_BASIC,
    DEVICE_ID_THRESHOLD_ENTERPRISE,
    DEVICE_ID_THRESHOLD_HIGH_END,
    DEVICE_ID_THRESHOLD_ULTRA_HIGH,
    DEVICE_ID_THRESHOLD_WIFI_ADVANCED,
    DEVICE_ID_THRESHOLD_WIFI_PREMIUM,
    DEVICE_ID_THRESHOLD_WIFI_ULTRA,
    DEVICE_PATTERN_HIGH_FEATURE,
    ...
    DEVICE_PATTERN_WIRELESS,
    ENTROPY_DIVISOR,
    ENTROPY_MASK,
    ENTROPY_VARIATION_FACTOR,
    ETHERNET_FLASH_SIZE,
    EXT_CAP_ID_ACS,
    EXT_CAP_ID_ARI,
    EXT_CAP_ID_LTR,
    EXT_CAP_ID_PTM,
    EXT_CAP_ID_SRIOV,
    INTEL_ENTERPRISE_MASK,
    INTEL_ENTERPRISE_THRESHOLD,
    LTR_LATENCY_ETHERNET,
    LTR_LATENCY_WIFI,
    MSIX_BAR_VARIATION_MASK,
    MSIX_BAR_VARIATION_THRESHOLD,
    MSIX_TABLE_ALIGN_MASK,
    MSIX_TABLE_ENTRY_SIZE,
    MSIX_TABLE_MIN_SIZE,
    NETWORK_CLASS_CODES,
    PTM_CLOCK_GRANULARITY,
    QUEUE_COUNT_ADVANCED,
    QUEUE_COUNT_HIGH,
    QUEUE_COUNT_ULTRA,
    REGISTER_SIZE_VARIATION_MASK,
    REGISTER_SIZE_VARIATION_MULTIPLIER,
    SIZE_PADDING_MASK,
    SRIOV_MIN_QUEUES,
    SRIOV_SUPPORTED_PAGE_SIZES,
    SRIOV_SYSTEM_PAGE_SIZE,
    VENDOR_ID_BROADCOM,
    VF_COUNT_HIGH,
    VF_COUNT_ULTRA,
    VF_COUNT_VARIATION_MASK,
